...
#' @param dir_path A character string indicating the directory path where the file will be saved.
...
#' specified in dir_path if it does not already exist. Defaults to FALSE.
#'
#' @details
